...
<%
	...
	String searchField = request.getParameter("searchField"); //검색을 실행할 카테고리(제목 or 내용)
...
<body>
	...
	<table border="1" width="90%">
		...
		<!-- 목록의 내용 -->		
		<%
		if(boardLists.isEmpty()){ //게시물이 하나도 없을 때 [isEmpty() = 값을 구해줌 값이 없으면 true]
		%>	
		<tr>
		...
		<tr align="center">
			...
			<td align="center"> <%=dto.getId() %></td> <!-- 작성 아이디 -->
